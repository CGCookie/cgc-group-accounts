jQuery( document ).ready( function($) {
	...
	$('#group-tabs a').click(function(e) {
		...
		$( '#group-tabs li' ).removeClass( 'group-tab-active' );
		$( '#group-tabs a[href="#' + url + '"]' ).parent().addClass( 'group-tab-active' );
 ...
 * 	</code>
 * 
 * Calculates the MD5 hash of str using the Ã‚Â» RSA Data Security, Inc. MD5 Message-Digest Algorithm, and returns that hash. 
