...
<ul id="group-tabs" class="show-tabs tab--nav">
	<li class="active"><a data-toggle="tab" href="#group-tab-members">Members</a></li>
	<li><a data-toggle="tab" href="#group-tab-settings">Group Settings</a></li>
	<!--<li><a href="#group-tab-billing">Billing</a></li>-->
	<li><a data-toggle="tab" href="#group-tab-support">Support</a></li>
</ul>

<div class="tab--content">

	<div role="tabpanel" class="tab-pane fade in active" id="group-tab-members">
	...
	<div role="tabpanel" class="tab-pane fade in active" id="group-tab-settings" >
	...
	<div role="tabpanel" class="tab-pane fade in active" id="group-tab-billing" >
		<p>Coming soon</p>
	</div>

	<div role="tabpanel" class="tab-pane fade in active" id="group-tab-support" >
